...
start /min "iCondo Backend" cmd /k "cd %~dp0backend && npm run dev"
...
start /min "iCondo Frontend" cmd /k "cd %~dp0frontend && npm run dev"
...
taskkill /f /im cmd.exe /fi "windowtitle eq iCondo Backend*" >nul 2>&1
